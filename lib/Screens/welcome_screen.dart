          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage(
                      'assets/Images/geometric-1732847.jpg'),
            ...
            children: [
              Expanded(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Text('Welcome to Acarate', style: TextStyle(fontSize: 55, fontWeight: FontWeight.bold, color: Colors.white),
                      textAlign: TextAlign.center),
                      Text('App made by:\n Marko Stahovec and Adrian Szacsko', style: TextStyle(fontSize: 18, fontStyle: FontStyle.italic, color: Colors.white),
                        textAlign: TextAlign.center),
                    ],
                  ),
                ),),
